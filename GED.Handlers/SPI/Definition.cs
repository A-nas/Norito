...
namespace GED.Handlers
{
    public static class Definition
    {
        ...
        public static List<string> pptActeNames = new List<string> { "reference_externe", "desinvestissements", "reinvestissements", "pieces", "commentaire", "support_saisie", "code_support", "pourcentage", "montant", "nom", "type", "date_signature", "taux_frais_deroge" , "incompressible_assureur_deroge", "code_profil"};
